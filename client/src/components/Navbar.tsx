    ...
    return (
        <div className="fixed top-0 left-0 w-full z-50 shadow-xl" style={{ height: `${NAVBAR_HEIGHT}px` }}>
            <div className="flex justify-between items-center w-full py-3 px-8 bg-primary-700 text-white">
                ...
                <div className="flex items-center gap-4 md:gap-6">
                    <Link href="/" className="cursor-pointer hover:!text-primary-300" scroll={false}>
                        <div className="flex items-center gap-3">
                            <Image src="/logo.svg" alt="RebtIFul" width={24} height={24} className="w-6 h-6" />
                ...
                {!isDashboardPage && (<p className="text-primary-200 hidden md:block"> Discover your perfect rental apartment with our advanced search.
                </p>)}
                    ...
                    {authUser ? (
                        <>
                            <div className="relative hidden md:block">
                                ...
                                />
                                <span className="absoulute top-0 right-0 w-2 h-2 bg-secondary-700 rounded-full">
                                </span>
                            </div>
                            <div className="relative hidden md:block">
                                <Bell
                            ...
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent className="bg-primary-700 text-white">
                                    <DropdownMenuItem
                                        className="cursor-pointer hover:bg-primary-700 hover:!text-gray-900"
                                        onClick={() => router.push(
